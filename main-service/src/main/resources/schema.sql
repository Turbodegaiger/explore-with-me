...
CONSTRAINT FK_EVENT_LOCATION FOREIGN KEY(location) REFERENCES locations(id)
);
...
CONSTRAINT FK_EVENT_ID_LIKED FOREIGN KEY(event) REFERENCES events(id),
CONSTRAINT FK_USER_ID_LIKED FOREIGN KEY(user_id) REFERENCES users(id)
);
